        ...
        <div className="header_wrapper">
            ...
            <div className={menuOpen ? "mobile_menu open" : "mobile_menu"}>
                ...
                <div className="mobile_menu_social_media_row">
                    <div>Find me on:</div>
                    <div className="mobile_menu_social_media_row_svgs">
                        <a className="mobile_menu_social_media_row_icon" href={"https://www.linkedin.com/in/divyansh-acharya-870a661bb/"}>
                        ...
                        <a className="mobile_menu_social_media_row_icon" href={"https://github.com/DA-11"}>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 50 50">
                        ...
                        <a className="mobile_menu_social_media_row_icon" href={"https://leetcode.com/DivyanshAcharya/"}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="leetcode" x="0px" y="0px" width="48" height="48" >
