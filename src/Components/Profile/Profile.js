...
export default function(){
    ...
    function approveRequest(gameID){
        console.log(gameID);
    ...
    function declineRequest(gameID){
    ...
    return (
        ...
        <div className='profile_container'>
            ...
            <div className='profile_container_feature_btn'>
                <div className='feature_btn_option' onClick={() => {handlePageVisibility("hostedGames")}}>
                    Hosted Games
                ...
                <div className='feature_btn_option' onClick={() => {handlePageVisibility("requestedGames")}}>
                    Requested Games
                ...
                <div className='feature_btn_option' >
                    Chats
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="icons">
