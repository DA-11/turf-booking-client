...
export default function LiveRequests(){
    ...
    function viewPendingReqSection(){
        ...
        return (
            ...
            <div className="live_request_navigate_section" onClick={() => {navigate('/profile')}}>
                <div>Go to Requests Section</div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="goto_request_page_icon">
    ...
    return (
        <div className="live_request_container">
            <div>
                <div className="pending_req_container_heading">Pending Request's</div>
